...
# kedro_video_custom documentation build
...
from kedro_video_custom import __version__ as release

# -- Project information -----------------------------------------------------

project = "kedro_video_custom"
copyright = "2020, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "kedro_video_customdoc"
...
latex_documents = [
    (
        master_doc,
        "kedro_video_custom.tex",
        "kedro_video_custom Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "kedro_video_custom",
        "Project kedro_video_custom codebase.",
        "Data-Science",
    )
]
